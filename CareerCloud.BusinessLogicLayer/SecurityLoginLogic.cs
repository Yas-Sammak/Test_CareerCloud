...
namespace CareerCloud.BusinessLogicLayer
{
        ...
        /*
         *  a. The definition of ‘SecurityLoginLogic’ can be found here: https://dotnetfiddle.net/itXkhc
         *  
            b. ‘SecurityLoginLogic’ contains validation code and authentication logic
                i. You will not need to create your own ‘SecurityLoginLogic’ class for the ‘SecurityLoginPoco’, 
                    using the one supplied is sufficient.
         */
